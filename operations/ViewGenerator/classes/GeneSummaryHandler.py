...
class GeneSummaryHandler( ) :
	...
	def __init__( self, sgRNAToGene ) :
		self.geneSummary = { }
		self.logPad = 1
		self.sgRNAToGene = sgRNAToGene
		
	def buildGeneSummary( self, fileReads, fileReadTotal, bgReads, bgTotals ) :
		...
		bgIDs = bgReads.keys( )
		allIDs = set(fgIDs + bgIDs)
		
		# Step through each one
		for sgRNAID in allIDs :
