...
namespace ORCA\app\classes\utilities;
...
use ORCA\app\lib\Navbar;
use ORCA\app\lib\Session;
...
class NavbarBuilder {
	...
	*/
	...
	private function generateNavbar( $isFluid = false ) {
		...
		$this->navbar[] = '<a class="navbar-brand" title="' . CONFIG['WEB']['WEB_NAME'] . " (" . CONFIG['WEB']['WEB_NAME_ABBR'] . ')" href="' . WEB_URL . '"><img src="' . IMG_URL . '/orca-icon-black.png" class="pull-left orcaNavIcon" alt="ORCA ICON" /> <strong>' . CONFIG['WEB']['WEB_NAME_ABBR'] . '</strong> <sup>' . CONFIG['WEB']['VERSION'] . '</sup></a></div>';
