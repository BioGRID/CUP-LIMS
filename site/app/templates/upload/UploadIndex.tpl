...
<div class='greyBG marginTopSm paddingLg marginBotSm'>
	<div class='container-fluid'>
		<div class='uploadForm col-lg-12 col-md-12 col-sm-12 col-xs-12'>
			...
			<div class='form-group col-lg-4 col-md-4'>
				...
				<input type='text' class='form-control' id='datasetDate' placeholder='Run Date (Format: YYYY-MM-DD)' value='{{TODAY}}'	/>
			</div>
			<div class='form-group col-lg-4 col-md-4'>
			...
			<div class='form-group col-lg-12 col-md-12'>
				...
				<input type='text' class='form-control' id='datasetDesc' placeholder='Brief Description of Experiment (ex. viability after 15 days, resistance to West Nile Virus)' />
			</div>
			<div class='col-lg-12 col-md-12 marginTopXs'>
			...
			<div class='marginTopSm col-lg-12 col-md-12'>
				<button class='btn btn-success btn-lg' type='button'><i class='fa fa-cloud-upload'></i> <strong>Upload Dataset</strong> </button>
			</div>
		</div>
	</div>
</div>