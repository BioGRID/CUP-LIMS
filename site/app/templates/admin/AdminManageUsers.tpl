<div class='primaryContent'>
	<div class='container-fluid'>
		...
		<div class='subheadLarge'>Use the following table to make adjustments to users in the system. This page is available only to powerusers and above, and you can only promote uers to your level or lower. Only an admin can create other admins, only a poweruser or admin can create powerusers etc.</div>
	</div>
</div>
